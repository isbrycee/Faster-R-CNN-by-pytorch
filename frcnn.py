...
class FRCNN(object):
    _defaults = {
        "model_path": 'logs/Epoch29-Total_Loss0.5442-Val_Loss0.7457.pth',
    ...
    def detect_image(self, image):
        ...
        photo = np.array(image, dtype=np.float32)/255  # 对图片进行归一化处理
        photo = np.transpose(photo, (2, 0, 1))  # 调整图片的通道数到第一维度 类似permute方法
